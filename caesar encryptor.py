...
# class for text to be encrypted.  Will require a string and also the key
    ...
    # def encrypt()
        # iterate through each position, which will be each a line of the text
...
# create an encrypted file object of class 'encrypted' or however I'll call the class
# call method encrypt providing the list of strings and the key, and assign the result (a string) to a variable, and print it, or... 
                                                                        # ...create a new file with the encrypted message
